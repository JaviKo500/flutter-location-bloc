...
class SearchBloc extends Bloc<SearchEvent, SearchState> {
  ...
  SearchBloc({
    ...
    on<OnDeactiveManualMarkerEvent>((event, emit) => emit( state.copyWith( displayManualMarker: false ) ));
  ...
  Future<RouteDestination> getCoorsStartToEnd( LatLng start, LatLng end ) async {
    ...
    return RouteDestination(points: latLngList, duration: duration, distance: distance, endPlace: endPlace);
  }
